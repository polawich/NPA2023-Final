#######################################################################################
# Yourname: Polawich Duangsuk
# Your student ID: 64070072
# Your GitHub Repo: https://github.com/polawich/NPA2023-Final
...
accessToken = "Bearer YmYwMzU2NWMtYmQ2ZC00ZjZkLWFjYzMtOTZlZmM4NWI2NjBkN2JlMDRhNWEtZjU1_P0A1_a61a0b2b-feba-43a3-8a20-e8cc10a43c9a"
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    #  e.g.  "/66070123 create"
    if message.find("/64070072") == 0:

        # extract the command
        command = message[11:] #เอาชื่อมาเก็บ
        print(command)
        # Debug print
